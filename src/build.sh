...
echo 'FVM 0.2.6.7 BETA Compilation script (C) Benderx2, 2014 under BSD 2-clause license.'
DFLAGS='-g' # Set this to 'g' if you want debugging info.
...
gcc $CFLAGS $DFLAGS -c fvm/devices/video.c -o video.o -I$FVM_INCLUDE -I$SDL_INCLUDE 
...
mv ./romdump.out ../bin/romdump.out
